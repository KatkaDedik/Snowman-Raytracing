...
class SceneObjectPtr {
  ...
  public:
     ...
     * @param 	material 	The UBO containing the material of the scene object.
     */
    SceneObjectPtr(Geometry& geometry, ModelUBO& model_ubo, PhongMaterialUBO& material) : SceneObjectPtr(&geometry, &model_ubo, &material, nullptr) {}
     ...
     */
    SceneObjectPtr(Geometry& geometry, ModelUBO& model_ubo, PhongMaterialUBO& material, GLuint& texture) : SceneObjectPtr(&geometry, &model_ubo, &material, &texture) {}
